...
public class ResultManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ActText.text = result.messages[0];
    ...
    public void NextButton()
    {
        ...
        switch (result.type)
        {
            ...
            case RewardType.Item:
                ...
                float[] itemWeights = GameManager.Instance.stageData[GameManager.Instance.stageIndex].foodWeights;
            ...
            case RewardType.Food:
                ...
                float[] foodWeights = GameManager.Instance.stageData[GameManager.Instance.stageIndex].foodWeights;
